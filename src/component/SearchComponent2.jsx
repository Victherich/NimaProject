...
const {propertiesData,handleSearch,propertyType,setPropertyType,bedrooms,setBedrooms,category,setCategory,minPrice,setMinPrice,maxPrice,setMaxPrice,state,setState}=useContext(Context)
